...
public List<Produit> produitsParCat(Long id) {
List<Produit> prods = entityManager.createQuery("select p from Produit p where p.categorie.idCat =" + id).getResultList();
		 return prods;
		}
		@Override
